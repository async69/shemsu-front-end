...
const Furniture = ({
  ...
  useEffect(() => {
    getProductsByCategory(productCategory.FURNITURE)
  }, [getProductsByCategory])

    return (
        <Fragment>
            <MetaTags>
            <title>Shemsu | Furniture Home</title>
            <meta
                name="description"
...
const mapStateToProps = ({ productReducer }) => ({
  ...
  export default connect(mapStateToProps, { getProductsByCategory })(Furniture)