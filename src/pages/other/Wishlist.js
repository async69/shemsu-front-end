...
import { _removeFromWishlist, _clearWishlist } from '../../redux/actions/Wishlist/wishlist'
                  ...
                  <div className="col-12">
                    <div className="table-content table-responsive cart-table-content">
                      <table>
                        ...
                        <tbody>
                          {wishlist.map((wishlistItem, key) => {
                            const discountedPrice = getDiscountPrice(
                              wishlistItem.productPrice,
                              wishlistItem.discount
                            )
                            const finalProductPrice = (
                              wishlistItem.productPrice * currency.currencyRate
                            ).toFixed(2)
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    deleteFromWishlist: (item, addToast, quantityCount) => {
      ...
      dispatch(_removeFromWishlist(item.productID))
    },
    deleteAllFromWishlist: (addToast) => {
      dispatch(deleteAllFromWishlist(addToast))
      dispatch(_clearWishlist())
    },
  }
}
